...
const ClientUpdate = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8000/client/show?id=${id}`)
      .then((response) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put("http://localhost:8000/client/update", formData, {
        headers,
      });
  ...
  return (
    <>
      ...
      <div className="max-w-2xl mx-auto mt-30 p-4 bg-white shadow-md rounded">
        <h1 className="text-2xl font-bold my-10">Modifier un client</h1>
